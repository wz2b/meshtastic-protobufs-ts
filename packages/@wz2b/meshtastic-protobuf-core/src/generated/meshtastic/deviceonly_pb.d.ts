 ...
 */
export declare const file_meshtastic_deviceonly: GenFile;
 ...
 */
export declare type PositionLite = Message<"meshtastic.PositionLite"> & {
  /**
   *
 ...
 */
export declare const PositionLiteSchema: GenMessage<PositionLite>;

/**
 * @generated from message meshtastic.UserLite
 */
export declare type UserLite = Message<"meshtastic.UserLite"> & {
  /**
   *
 ...
 */
export declare const UserLiteSchema: GenMessage<UserLite>;

/**
 * @generated from message meshtastic.NodeInfoLite
 */
export declare type NodeInfoLite = Message<"meshtastic.NodeInfoLite"> & {
  /**
   *
   * The node number
   *
 ...
 */
export declare const NodeInfoLiteSchema: GenMessage<NodeInfoLite>;
 ...
 */
export declare type DeviceState = Message<"meshtastic.DeviceState"> & {
  /**
   *
 ...
 */
export declare const DeviceStateSchema: GenMessage<DeviceState>;

/**
 * @generated from message meshtastic.NodeDatabase
 */
export declare type NodeDatabase = Message<"meshtastic.NodeDatabase"> & {
  /**
   *
   * A version integer used to invalidate old save files when we make
   * incompatible changes This integer is set at build time and is private to
 ...
 */
export declare const NodeDatabaseSchema: GenMessage<NodeDatabase>;
 ...
 */
export declare type ChannelFile = Message<"meshtastic.ChannelFile"> & {
  /**
   *
 ...
 */
export declare const ChannelFileSchema: GenMessage<ChannelFile>;
 ...
 */
export declare type BackupPreferences = Message<"meshtastic.BackupPreferences"> & {
  /**
   *
 ...
 */
export declare const BackupPreferencesSchema: GenMessage<BackupPreferences>;
