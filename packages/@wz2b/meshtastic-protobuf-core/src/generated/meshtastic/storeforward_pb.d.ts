 ...
 */
export declare const file_meshtastic_storeforward: GenFile;
 ...
 */
export declare type StoreAndForward = Message<"meshtastic.StoreAndForward"> & {
  /**
   *
   * TODO: REPLACE
   *
 ...
 */
export declare const StoreAndForwardSchema: GenMessage<StoreAndForward>;
 ...
 */
export declare type StoreAndForward_Statistics = Message<"meshtastic.StoreAndForward.Statistics"> & {
  /**
   *
 ...
 */
export declare const StoreAndForward_StatisticsSchema: GenMessage<StoreAndForward_Statistics>;
 ...
 */
export declare type StoreAndForward_History = Message<"meshtastic.StoreAndForward.History"> & {
  /**
   *
 ...
 */
export declare const StoreAndForward_HistorySchema: GenMessage<StoreAndForward_History>;
 ...
 */
export declare type StoreAndForward_Heartbeat = Message<"meshtastic.StoreAndForward.Heartbeat"> & {
  /**
   *
 ...
 */
export declare const StoreAndForward_HeartbeatSchema: GenMessage<StoreAndForward_Heartbeat>;
 ...
 */
export declare const StoreAndForward_RequestResponseSchema: GenEnum<StoreAndForward_RequestResponse>;
