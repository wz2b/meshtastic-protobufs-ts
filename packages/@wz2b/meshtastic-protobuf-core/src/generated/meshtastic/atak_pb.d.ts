 ...
 */
export declare const file_meshtastic_atak: GenFile;
 ...
 */
export declare type TAKPacket = Message<"meshtastic.TAKPacket"> & {
  /**
   *
 ...
 */
export declare const TAKPacketSchema: GenMessage<TAKPacket>;
 ...
 */
export declare type GeoChat = Message<"meshtastic.GeoChat"> & {
  /**
   *
   * The text message
   *
 ...
 */
export declare const GeoChatSchema: GenMessage<GeoChat>;
 ...
 */
export declare type Group = Message<"meshtastic.Group"> & {
  /**
   *
 ...
 */
export declare type Status = Message<"meshtastic.Status"> & {
  /**
   *
   * Battery level
   *
 ...
 */
export declare type Contact = Message<"meshtastic.Contact"> & {
  /**
   *
   * Callsign
   *
 ...
 */
export declare type PLI = Message<"meshtastic.PLI"> & {
  /**
   *
 ...
 */
export declare const PLISchema: GenMessage<PLI>;
